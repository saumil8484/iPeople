 <%@ Page Language="C#" AutoEventWireup="true" CodeFile="Appraisal.aspx.cs" Inherits="Appraisal" %>

<!DOCTYPE html>
<html lang="en">
<head>
    <!-- Website Title -->
    <title>Appraisal-iPeople</title>
...
<body data-spy="scroll" data-target=".fixed-top">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="breadcrumbs">
                        <a href="Dashboard.aspx">Dashboard</a><i class="fa fa-angle-double-right"></i><a href="Dashboard.aspx#Employees"><span>Administration</span></a><i class="fa fa-angle-double-right"></i><span>Appraisal</span>
    ...
    <center>
        ...
        <asp:Label ID="Label1" runat="server" Text="Employee Name :" style="text-align: left" Width="150px"></asp:Label>
        <asp:DropDownList ID="name" runat="server" DataSourceID="SqlDataSource1" DataTextField="ename" DataValueField="ename" Width="128px">
        </asp:DropDownList>
         <br />
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:DropDownConnectionString %>" SelectCommand="SELECT [ename] FROM [EmpTable]"></asp:SqlDataSource>
        <br />
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:Label ID="Label2" runat="server" Text="Month:" style="text-align: left" Width="150px"></asp:Label>
        <asp:DropDownList ID="month" runat="server" Width="128px">
        ...
        <br />
        <br />
        <asp:Label ID="Label3" runat="server" Text="1. The employee is physically and mentally fit to discharge his/her duties." style="text-align: left" Width="550px"></asp:Label>
        ...
        <br />
        <br />
        <asp:Label ID="Label4" runat="server" Text="2. The employee put his/her best efforts in their role." style="text-align: left" Width="550px"></asp:Label>
        ...
        <br />
        <br />
        <asp:Label ID="Label5" runat="server" Text="3. The employee has proactive approach towards his/her role & comapny." style="text-align: left" Width="550px"></asp:Label>
        ...
        <br />
        <br />
        <asp:Label ID="Label6" runat="server" Text="4. The employee takes ownership of his/her role & organization." style="text-align: left" Width="550px"></asp:Label>
        ...
        <br />
        <br />
        <asp:Label ID="Label7" runat="server" Text="5. The employee could have delivered better performance." style="text-align: left" Width="550px"></asp:Label>
        ...
        <br />
        <br />
        <asp:Label ID="Label8" runat="server" Text="6. The employee will deliver better performance in next quarter." style="text-align: left" Width="550px"></asp:Label>
        ...
        <br />
        <br />
        <asp:Label ID="Label9" runat="server" Text="7. The employee is a right fit for his her role." style="text-align: left" Width="550px"></asp:Label>
        ...
        <br />
        <br />
        <asp:Label ID="Label10" runat="server" Text="8. The employee is a right fit for the culture of organization." style="text-align: left" Width="550px"></asp:Label>
        <asp:DropDownList ID="a8" runat="server" Width="150px">
            <asp:ListItem>Strongly Agree</asp:ListItem>
            <asp:ListItem>Slightly Agree</asp:ListItem>
            <asp:ListItem>Neutral</asp:ListItem>
            <asp:ListItem>Slightly Disagree</asp:ListItem>
        ...
        <br />
        <br />
        <asp:Button class="btn-solid-reg page-scroll" ID="Button1" runat="server" Text="Submit" OnClick="Button1_Click" />
        <br />
