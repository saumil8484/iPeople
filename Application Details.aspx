<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Application Details.aspx.cs" Inherits="Application_Details" %>

<!DOCTYPE html>
<html lang="en">
<head>
    <!-- Website Title -->
    <title>Application Details-iPeople</title>
...
<body data-spy="scroll" data-target=".fixed-top">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="breadcrumbs">
                        <a href="Dashboard.aspx">Dashboard</a><i class="fa fa-angle-double-right"></i><a href="Dashboard.aspx#recruitment"><span>Recruitment</span></a><i class="fa fa-angle-double-right"></i><a href="Job Applications.aspx"><span>Review Applications</span></a><i class="fa fa-angle-double-right"></i><span>Application Details</span>
   ...
   <center>
        ...
        <asp:TextBox ID="aid" runat="server" BorderStyle="Solid" Width="256px" TextMode="Number"></asp:TextBox>
        <br />
        <br />
        ...
        <asp:TextBox ID="aphno" runat="server" BorderStyle="Solid" Width="256px" TextMode="Phone"></asp:TextBox>
        <br />
        <br />
        <asp:Label ID="Label5" runat="server" style="text-align: left" Text="Applicant Email ID :" Width="256px"></asp:Label>
        <asp:TextBox ID="amail" runat="server" BorderStyle="Solid" Width="256px" TextMode="Email"></asp:TextBox>
        <br />
        <br />
        <asp:Label ID="Label6" runat="server" style="text-align: left" Text="CV Link :" Width="256px"></asp:Label>
        <asp:TextBox ID="acvlink" runat="server" BorderStyle="Solid" Width="256px" TextMode="Url"></asp:TextBox>
        <br />
        <br />
        <asp:Label ID="Label7" runat="server" style="text-align: left" Text="Application Submission Date :" Width="256px"></asp:Label>
        <asp:TextBox ID="adate" runat="server" BorderStyle="Solid" Width="256px"></asp:TextBox>
        <br />
        <br />
        <asp:Label ID="Label8" runat="server" style="text-align: left" Text="Knowledge Assessment :" Width="256px"></asp:Label>
        <asp:TextBox ID="aknow" runat="server" BorderStyle="Solid" Width="256px" TextMode="Number"></asp:TextBox>
        <br />
        <br />
        <asp:Label ID="Label9" runat="server" style="text-align: left" Text="Skill Assessment :" Width="256px"></asp:Label>
        <asp:TextBox ID="askill" runat="server" BorderStyle="Solid" Width="256px" TextMode="Number"></asp:TextBox>
        <br />
        <br />
        <asp:Label ID="Label10" runat="server" style="text-align: left" Text="Personlity Assessment :" Width="256px"></asp:Label>
        <asp:TextBox ID="apersona" runat="server" BorderStyle="Solid" Width="256px" TextMode="Number"></asp:TextBox>
        <br />
        <br />
        <asp:Label ID="Label11" runat="server" style="text-align: left" Text="Values Assessment :" Width="256px"></asp:Label>
        <asp:TextBox ID="avalue" runat="server" BorderStyle="Solid" Width="256px" TextMode="Number"></asp:TextBox>
        <br />
        <br />
        <asp:Label ID="Label12" runat="server" style="text-align: left" Text="Task Assessment :" Width="256px"></asp:Label>
        <asp:TextBox ID="atask" runat="server" BorderStyle="Solid" Width="256px" TextMode="Number"></asp:TextBox>
        <br />
        <br />
        <asp:Label ID="Label13" runat="server" style="text-align: left" Text="Final Score :" Width="256px"></asp:Label>
        <asp:TextBox ID="ascore" runat="server" BorderStyle="Solid" Width="256px" TextMode="Number"></asp:TextBox>
        <br />
        <br />
        <asp:Label ID="Label14" runat="server" style="text-align: left" Text="Final Decision :" Width="256px"></asp:Label>
        <asp:DropDownList ID="afinal" runat="server" Width="265px">
        ...
        <br />
        <asp:Button  ID="Button1" runat="server" OnClick="Button1_Click" Text="Back" class="btn-solid-reg page-scroll" />
&nbsp;&nbsp;&nbsp;
        <asp:Button  ID="Button2" runat="server" OnClick="Button2_Click" Text="Save" class="btn-solid-reg page-scroll" />
        </center>
    </form>
