<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Insights.aspx.cs" Inherits="Insights" %>

<!DOCTYPE html>
<html lang="en">
<head>
    <!-- Website Title -->
    <title>Insights-iPeople</title>
...
<body data-spy="scroll" data-target=".fixed-top">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="breadcrumbs">
                        <a href="Dashboard.aspx">Dashboard</a><i class="fa fa-angle-double-right"></i><span>Insights</span>
    ...
    <div>
            ...
            <br />
            <br />
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="false" Width="960px" OnSelectedIndexChanged="GridView1_SelectedIndexChanged">
            <Columns>
                <asp:BoundField DataField="name" HeaderText ="Name" />
                <asp:BoundField DataField="plif" HeaderText ="Personal Life" />
                <asp:BoundField DataField="subs" HeaderText ="Subsistence" />
                <asp:BoundField DataField="orel" HeaderText ="Office Relationships" />
                <asp:BoundField DataField="prel" HeaderText ="Potential Realised" />
                <asp:BoundField DataField="opro" HeaderText ="Organization Promoter" />
                <asp:BoundField DataField="eret" HeaderText ="Expected Retention" />
                <asp:BoundField DataField="lpip" HeaderText ="Leadership Pipeline" />
            </Columns>
            </asp:GridView>
            <br />
            <br />
