<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Job Applications.aspx.cs" Inherits="Job_Applications" %>

<!DOCTYPE html>
<html lang="en">
<head>
    <!-- Website Title -->
    <title>Review Applications-iPeople</title>
...
<body data-spy="scroll" data-target=".fixed-top">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="breadcrumbs">
                        <a href="Dashboard.aspx">Dashboard</a><i class="fa fa-angle-double-right"></i><a href="Dashboard.aspx#recruitment"><span>Recruitment</span></a><i class="fa fa-angle-double-right"></i><span>Review Applications</span>
    ...
    <center>
        ...
        <br />
        <br />
        <asp:GridView ID="apptgrid" runat="server" AutoGenerateColumns="false" Width="701px">
        <Columns>
            <asp:BoundField DataField="pname" HeaderText ="Position" />
            <asp:BoundField DataField="aname" HeaderText ="Applicant" />
            <asp:TemplateField>
                <ItemTemplate>
