<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Positions Update.aspx.cs" Inherits="Positions_Update" %>
...
<body data-spy="scroll" data-target=".fixed-top">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="breadcrumbs">
                        <a href="Dashboard.aspx">Dashboard</a><i class="fa fa-angle-double-right"></i><a href="Dashboard.aspx#recruitment"><span>Recruitment</span></a><i class="fa fa-angle-double-right"><a href="Job Positions.aspx"></i><span>Manage Vacancies</span></a><i class="fa fa-angle-double-right"></i><span>Vacancy Details</span>
   ...
   <center>
        ...
        <span class="auto-style1">Position Details</span><br />
        <br />
        ...
        <asp:DropDownList ID="pdept" runat="server" Width="265px">
        ...
        <br />
        <asp:Label ID="Label20" runat="server" Text="No. of positions vacant :" style="text-align: left" Width="256px"></asp:Label>
        <asp:TextBox ID="pvac" runat="server" BorderStyle="Solid" Width="256px" TextMode="Number"></asp:TextBox>
        <br />
        <asp:Label ID="Label47" runat="server" Width="256px"></asp:Label>
        <asp:RequiredFieldValidator ID="RequiredFieldValidator23" runat="server" ControlToValidate="pvac" Display="Dynamic" ErrorMessage="Please fill above detail !" ForeColor="Red" Width="256px"></asp:RequiredFieldValidator>
        <br />
        <br />
        <br />
        <br />
...
&nbsp;&nbsp;&nbsp;
        <asp:Button class="btn-solid-reg page-scroll" ID="Button2" runat="server" OnClick="Button2_Click" Text="Update" />
&nbsp;&nbsp;&nbsp;
        <asp:Button class="btn-solid-reg page-scroll" ID="Button3" runat="server" OnClick="Button3_Click" Text="Delete" />
    </center>
    </form>
