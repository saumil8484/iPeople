<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Payroll Generate.aspx.cs" Inherits="Payroll_Generate" %>

<!DOCTYPE html>
<html lang="en">
<head>
    <!-- Website Title -->
    <title>Generate Payroll-iPeople</title>
...
<body data-spy="scroll" data-target=".fixed-top">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="breadcrumbs">
                        <a href="Dashboard.aspx">Dashboard</a><i class="fa fa-angle-double-right"></i><a href="Dashboard.aspx#Employees"><span>Administration</span></a><i class="fa fa-angle-double-right"></i><a href="Employee Payroll.aspx"><span>Payroll</span></a><i class="fa fa-angle-double-right"></i><span>Generate Payroll</span>
    ...
    <center>
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:Button class="btn-solid-reg page-scroll" ID="Button2" runat="server" OnClick="Button2_Click" Text="Generate" />
        <br />
        <br />
        ...
        <br />
        <asp:Button class="btn-solid-reg page-scroll" ID="Button4" runat="server" OnClick="Button4_Click" Text="Delete Payroll" />
        <br />
        </center>
    </form>
