<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Attendance Today.aspx.cs" Inherits="Attendance_Today" %>

<!DOCTYPE html>
<html lang="en">
<head>
    <!-- Website Title -->
    <title>Today's Attendance-iPeople</title>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="breadcrumbs">
                        <a href="Dashboard.aspx">Dashboard</a><i class="fa fa-angle-double-right"></i><a href="Dashboard.aspx#Employees"><span>Administration</span></a><i class="fa fa-angle-double-right"></i><a href="Employee Attendance.aspx"><span>Attendance</span></a><i class="fa fa-angle-double-right"></i><span>Today's Attendance</span>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <br />
        <br />
        <asp:GridView ID="TodayAttGridView" runat="server" AutoGenerateColumns="false" Width="791px" >
        <Columns>
            ...
            <asp:TemplateField>
                <ItemTemplate>
                    <asp:LinkButton ID ="present" text ="Present"  runat="server" CommandArgument='<%# Eval ("Id")%>' OnClick ="present_Click"/>
                </ItemTemplate>
            </asp:TemplateField>
            <asp:TemplateField>
                <ItemTemplate>
                    <asp:LinkButton ID ="absent" text ="Absent"  runat="server" CommandArgument='<%# Eval ("Id")%>' OnClick ="absent_Click"/>
                </ItemTemplate>
            </asp:TemplateField>
        </Columns>
        </asp:GridView>
