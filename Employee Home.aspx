...
<head>
    <!-- Website Title -->
    <title>Employee Hub-iPeople</title>
...
<body data-spy="scroll" data-target=".fixed-top">
   <form id="form1" runat="server"> 
    ...
    <nav class="navbar navbar-expand-md navbar-dark navbar-custom fixed-top">
       ...
       <div class="collapse navbar-collapse" id="navbarsExampleDefault">
            <ul class="navbar-nav ml-auto">
                <li class="nav-item">
                    <a class="nav-link page-scroll" href="#header">Hub<span class="sr-only">(current)</span></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link page-scroll" href="#personalinfo">Personal Info</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link page-scroll" href="#survey">Survey</a>
                </li>
                <li class="nav-item">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="breadcrumbs">
                        <a>Employee Hub</a><i class="fa fa-angle-double-right"></i>
    ...
    <!-- end of breadcrumbs -->
         ...
         &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Label ID="Label2" runat="server" Text="Welcome, "></asp:Label><asp:Label ID="Label1" runat="server"></asp:Label>
 <!-- personalinfo -->
    <div id="personalinfo" class="cards-2">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-title">Personal Info</div>
                    <h2>Review or Update<br> your personal details</h2>
                    
                </div> <!-- end of col -->
            </div> <!-- end of row -->
            <center> 
             <asp:Button class="btn-solid-lg page-scroll" ID="Button3" runat="server" OnClick="Button1_Click" Text="View Personal Info" />
            </center>
   ...
   <!-- survey -->
    <div id="survey" class="cards-2">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-title">Survey</div>
                    <h2>Actively take part in survey <br> for better future endeavours</h2>
                    
                </div> <!-- end of col -->
            </div> <!-- end of row -->
            <center> 
            <asp:Button class="btn-solid-lg page-scroll" ID="Button2" runat="server" OnClick="Button2_Click" Text="Give Survey" />
             </center>
        </div> <!-- end of container -->
    </div> <!-- end of cards-2 -->
    <!-- end of survey -->   
